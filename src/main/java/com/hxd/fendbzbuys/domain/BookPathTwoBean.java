...
public class BookPathTwoBean  {
    ...
    @Generated(hash = 284693707)
    private transient BookPathTwoBeanDao myDao;
    @Generated(hash = 1765896118)
    public BookPathTwoBean(Long id, String bookId, String netUrl, String content,
    ...
    @Generated(hash = 1480953810)
    public BookPathTwoBean() {
    }
    public Long getId() {
        return this.id;
    }
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 2040406454)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getBookPathTwoBeanDao() : null;
    }
