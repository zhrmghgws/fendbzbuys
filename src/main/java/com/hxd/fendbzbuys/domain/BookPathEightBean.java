...
@Entity
public class BookPathEightBean  {
    ...
    @Generated(hash = 1847537684)
    private transient BookPathEightBeanDao myDao;
    @Generated(hash = 1751186918)
    public BookPathEightBean(Long id, String bookId, String netUrl, String content,
    ...
    @Generated(hash = 1747918323)
    public BookPathEightBean() {
    }
    public Long getId() {
        return this.id;
    }
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 39279866)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getBookPathEightBeanDao() : null;
    }
