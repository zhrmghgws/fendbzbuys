...
public class BookPathSixBean  {
    ...
    @Generated(hash = 965221091)
    private transient BookPathSixBeanDao myDao;
    @Generated(hash = 498780312)
    public BookPathSixBean(Long id, String bookId, String netUrl, String content,
    ...
    @Generated(hash = 883738784)
    public BookPathSixBean() {
    }
    public Long getId() {
        return this.id;
    }
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 499522800)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getBookPathSixBeanDao() : null;
    }
}
