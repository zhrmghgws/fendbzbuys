...
@Entity
public class BookPathThreeBean {
    ...
    @Generated(hash = 1505712326)
    private transient BookPathThreeBeanDao myDao;
    @Generated(hash = 819020635)
    public BookPathThreeBean(Long id, String bookId, String netUrl, String content,
    ...
    @Generated(hash = 493282964)
    public BookPathThreeBean() {
    }
    public Long getId() {
        return this.id;
    }
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 233284935)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getBookPathThreeBeanDao() : null;
    }
}
