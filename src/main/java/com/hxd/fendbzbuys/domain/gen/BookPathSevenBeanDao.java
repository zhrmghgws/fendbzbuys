...
/** 
 * DAO for table "BOOK_PATH_SEVEN_BEAN".
*/
public class BookPathSevenBeanDao extends AbstractDao<BookPathSevenBean, Long> {

    public static final String TABLENAME = "BOOK_PATH_SEVEN_BEAN";

    /**
     * Properties of entity BookPathSevenBean.<br/>
    ...
    public BookPathSevenBeanDao(DaoConfig config) {
        super(config);
    }
    
    public BookPathSevenBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BOOK_PATH_SEVEN_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"BOOK_PATH_SEVEN_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, BookPathSevenBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, BookPathSevenBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(BookPathSevenBean entity) {
    ...
    @Override
    public BookPathSevenBean readEntity(Cursor cursor, int offset) {
        BookPathSevenBean entity = new BookPathSevenBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, BookPathSevenBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(BookPathSevenBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(BookPathSevenBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(BookPathSevenBean entity) {
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM BOOK_PATH_SEVEN_BEAN T");
    ...
    protected BookPathSevenBean loadCurrentDeep(Cursor cursor, boolean lock) {
        BookPathSevenBean entity = loadCurrent(cursor, 0, lock);
    ...
    public BookPathSevenBean loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<BookPathSevenBean> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<BookPathSevenBean> list = new ArrayList<BookPathSevenBean>(count);
    ...
    protected List<BookPathSevenBean> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<BookPathSevenBean> queryDeep(String where, String... selectionArg) {
