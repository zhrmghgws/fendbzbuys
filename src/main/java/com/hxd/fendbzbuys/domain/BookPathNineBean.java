...
public class BookPathNineBean {
    ...
    @Generated(hash = 514278820)
    private transient BookPathNineBeanDao myDao;
    @Generated(hash = 1796051523)
    public BookPathNineBean(Long id, String bookId, String netUrl, String content,
    ...
    @Generated(hash = 718371819)
    public BookPathNineBean() {
    }
    public Long getId() {
        return this.id;
    }
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 1591988390)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getBookPathNineBeanDao() : null;
    }
