...
public class BookPathFiveBean {
    ...
    @Generated(hash = 427403800)
    private transient BookPathFiveBeanDao myDao;
    @Generated(hash = 2035483519)
    public BookPathFiveBean(Long id, String bookId, String netUrl, String content,
    ...
    @Generated(hash = 910276457)
    public BookPathFiveBean() {
    }
    public Long getId() {
        return this.id;
    }
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 437077278)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getBookPathFiveBeanDao() : null;
    }
