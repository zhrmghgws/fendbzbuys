...
public class BookPathOneBean {
    ...
    @Generated(hash = 17551920)
    private transient BookPathOneBeanDao myDao;
    @Generated(hash = 1719560367)
    public BookPathOneBean(Long id, String bookId, String netUrl, String content,
    ...
    @Generated(hash = 126169381)
    public BookPathOneBean() {
    }
    public Long getId() {
        return this.id;
    }
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 1330398215)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getBookPathOneBeanDao() : null;
    }
