...
public class BookPathFourBean {
    ...
    @Generated(hash = 1488879594)
    private transient BookPathFourBeanDao myDao;
    @Generated(hash = 2023496409)
    public BookPathFourBean(Long id, String bookId, String netUrl, String content,
    ...
    @Generated(hash = 1765544145)
    public BookPathFourBean() {
    }
    public Long getId() {
        return this.id;
    }
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 502062672)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getBookPathFourBeanDao() : null;
    }
